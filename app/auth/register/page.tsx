    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4">
      <div className="text-center space-y-5 animate-in fade-in zoom-in duration-300 max-w-sm">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Sekarang kamu bisa menggunakan API SnapYin.</p>
        </div>
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-3 rounded-xl border border-border bg-muted/30 p-4">
                  ...
                  <label htmlFor="terms" className="text-xs text-muted-foreground leading-relaxed cursor-pointer">
                    ...
                    {" "}dan{" "}
                    <Link href="/guide" className="text-primary font-medium hover:underline">Syarat & Ketentuan</Link>{" "}
                    layanan SnapYin. Kami tidak menyimpan atau menjual data pribadi kamu.
                  </label>
                </div>
              </form>
